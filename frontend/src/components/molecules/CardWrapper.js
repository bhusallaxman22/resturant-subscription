    ...
    return (
        <Box
            sx={{
                ...
                boxShadow:
                    '12px 12px 32px rgba(0, 0, 0, 0.06), -8px -8px 24px rgba(255, 255, 255, 0.8), inset 2px 2px 4px rgba(255, 255, 255, 0.6)',
        ...
        >
            ...
            <Box sx={{ flex: 1, position: 'relative', zIndex: 2 }}>{children}</Box>
        </Box>
    );
};
